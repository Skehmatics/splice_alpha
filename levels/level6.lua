...
function level:events(t)
	if t == 33 then
		sum(grid.x1, grid.y1, "x+", 9)
		sum(grid.x1, grid.y3, "x+", 9)
	elseif t == 34 then
	...
	elseif t == 37 then
		sum(grid.x1, grid.y3, "x+", 30)
		sum(grid.x1, grid.y1, "x-", 30)
		sum(grid.x1, grid.y3, "y-", 30, 1/2)
		sum(grid.x3, grid.y1, "y+", 30, 1/2)
	elseif t == 38 then
		sum(grid.x1, grid.y2, "x+", 30, 1/4)
		sum(grid.x3, grid.y2, "x-", 30, 1/4)
	elseif t == 39 then
	...
	elseif t == 42 then
		sum(grid.x1, grid.y1, "x+", 20)
		sum(grid.x2, grid.y1, "y+", 30, 1/4)
		sum(grid.x3, grid.y1, "x-", 20)
		sum(grid.x1, grid.y3, "x+", 20)
		sum(grid.x2, grid.y3, "y-", 30, 1/3)
		sum(grid.x3, grid.y3, "x-", 20)
	elseif t == 43 then
